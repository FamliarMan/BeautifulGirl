 ...
 */
class NotContainTextHandler(singleRule: String) : AbstractRuleHandler(singleRule) {
    private val notContainTextRegex = Regex("^@notContainText:<(.*)>$")
    ...
    override fun getRuleDesc(): RuleDesc {
        return getRuleDesc(singleRule, null, notContainTextRegex)
    }
}